    ...
    <section id="roadmap" className="w-full py-12 px-4 bg-background text-foreground relative">
      <div className="w-full max-w-3xl mx-auto text-center">
        ...
        <div className="mt-10">
          ...
          <a href="#mentorship" className="bg-[color:var(--primary)] text-[color:var(--primary-foreground)] px-6 py-2 rounded-full hover:brightness-90 transition text-sm md:text-base lg:text-lg">
            START YOUR JOURNEY
          </a>
        </div>
      </div>
