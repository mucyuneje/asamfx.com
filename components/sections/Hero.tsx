  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Subheadline: hide on mobile */}
        <p className="mb-4 text-base md:text-lg xl:text-xl 2xl:text-2xl text-[color:var(--foreground)] hidden sm:block">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start lg:justify-center">
          <a
            href="#mentorship"
            className="px-5 py-2 rounded transition text-base md:text-lg xl:text-xl
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 1 }}
        className="flex-1 flex justify-center md:justify-end mb-0 md:mb-0 lg:justify-center"
      >
