    ...
    <section id="system" className="w-full py-12 px-4 bg-background text-foreground">
      <div className="max-w-5xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-6">
        ...
        >
          ...
          <a href="#mentorship" className="mt-4 bg-[color:var(--primary)] text-[color:var(--primary-foreground)] px-5 py-2 rounded-full hover:brightness-90 transition text-sm md:text-base">
            Start Trading Today
          </a>
        </motion.div>
      </div>
